import { MAC_KEYCODES, WINDOWS_KEYCODES, LINUX_KEYCODES } from "./keycodes";
...
export const LINUX_MODIFIER_KEYCODES = new Set<number>([
  LINUX_KEYCODES.META,
  LINUX_KEYCODES.RMETA,
  LINUX_KEYCODES.CTRL,
  LINUX_KEYCODES.RCTRL,
  LINUX_KEYCODES.ALT,
  LINUX_KEYCODES.RALT,
  LINUX_KEYCODES.SHIFT,
  LINUX_KEYCODES.RSHIFT,
  LINUX_KEYCODES.FN,
]);
...
export const LINUX_MODIFIER_PAIRS: [number, number][] = [
  [LINUX_KEYCODES.SHIFT, LINUX_KEYCODES.RSHIFT],
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.RCTRL],
  [LINUX_KEYCODES.ALT, LINUX_KEYCODES.RALT],
  [LINUX_KEYCODES.META, LINUX_KEYCODES.RMETA],
];
...
export const LINUX_SPECIAL_KEYCODES = new Set<number>([
  LINUX_KEYCODES.SPACE,
  LINUX_KEYCODES.TAB,
  LINUX_KEYCODES.ENTER,
  LINUX_KEYCODES.ESCAPE,
  LINUX_KEYCODES.BACKSPACE,
  LINUX_KEYCODES.DELETE,
  LINUX_KEYCODES.F1,
  LINUX_KEYCODES.F2,
  LINUX_KEYCODES.F3,
  LINUX_KEYCODES.F4,
...
// Linux reserved shortcuts use evdev keycodes
// Mirrors common GNOME/KDE system shortcuts
const RESERVED_SHORTCUTS_LINUX_BASE: number[][] = [
  // Clipboard
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.C],
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.V],
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.X],
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.Z],
  // Window/App management
  [LINUX_KEYCODES.ALT, LINUX_KEYCODES.TAB],
  [LINUX_KEYCODES.ALT, LINUX_KEYCODES.F4],
  [LINUX_KEYCODES.F11],
  // File operations
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.N],
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.S],
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.W],
  // Edit
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.A],
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.F],
  // Super key shortcuts (GNOME)
  [LINUX_KEYCODES.META, LINUX_KEYCODES.L],
  [LINUX_KEYCODES.META, LINUX_KEYCODES.D],
  [LINUX_KEYCODES.META, LINUX_KEYCODES.TAB],
  // System
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.ALT, LINUX_KEYCODES.DELETE],
  [LINUX_KEYCODES.CTRL, LINUX_KEYCODES.ALT, LINUX_KEYCODES.T],
];
...
export const RESERVED_SHORTCUTS_LINUX = expandReservedShortcuts(
  RESERVED_SHORTCUTS_LINUX_BASE,
